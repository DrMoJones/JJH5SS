...
namespace H5SS.Controllers
{
    ...
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Navn,Password")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Navn,Password")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
